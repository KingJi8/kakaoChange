...
function loadChatBubbles(count) {
  ...
  console.log(prevLastChatBubble,prevLastChatBubblePosition);
  ...
  for (let i = 0; i < count; i++) {
    ...
    const chatBubbleElement = chatBubble(textArray[chatIndex],chatIndex);
  ...
  if (prevLastChatBubble) {
      ...
      txtLog.scrollTop += positionDifference;
  } else {
...
// 채팅 버블 요소를 생성하는 함수
function chatBubble(line,lineNo) {
